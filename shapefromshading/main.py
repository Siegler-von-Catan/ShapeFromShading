...
def main():
    parser = argparse.ArgumentParser(
        description="Seal Shape From Shading out of Potsdam"
    )
    parser.add_argument("source")
    parser.add_argument(
        "-o", "--output", help="Filename to write to", default="out.png"
    )
    parser.add_argument(
        "-alg",
        "--algorithm",
        help="Shape from Shading Algorithm to use",
        default="tsai_shah_specular",
    ...
    parser.add_argument(
        "-l",
        "--loglevel",
        help='Set debugging level. Use "debug" for highest details',
        default="critical",
    )
    parser.add_argument(
        "-opt",
        "--optimize",
        help="Optimize parameters using genetically algorithm",
        action="store_true",
    )
